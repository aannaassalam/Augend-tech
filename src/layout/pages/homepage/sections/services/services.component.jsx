            ...
            <div className="services">
                <div className="top">
                    ...
                    <div className="option-list">
                        <div className={this.state.tab1} id="ue" onClick={this.handleShow1}>
                            <i className="flaticon-ambient"></i>
                            <h3>User Experience</h3>
                        </div>
                        <div className={this.state.tab2} id="pd" onClick={this.handleShow2}>
                            <i className="flaticon-design"></i>
                            <h3>Product Design</h3>
                        </div>
                        <div className={this.state.tab3}  id="dm" onClick={this.handleShow3}>
                            <i className="flaticon-content"></i>
                            <h3>Digital Marketing</h3>
                        </div>
                        <div className={this.state.tab4}  id="br" onClick={this.handleShow4}>
                            <i className="flaticon-spread"></i>
                            <h3>Branding</h3>
                        </div>
                        <div className={this.state.tab5}  id="de" onClick={this.handleShow5}>
                            <i className="flaticon-layout"></i>
                            <h3>Develpment</h3>
                        </div>
                        <div className={this.state.tab6}  id="an" onClick={this.handleShow6}>
