    ...
    return (
      <div className="pdbox">
        <div className="left">
          ...
          <h3>
            Enterprise-wide solutions transforming highly complex business
            requirements into simplified user interfaces bringing about a
            widespread user engagement is what we promise as part of our UI
            solutions.
          </h3>
