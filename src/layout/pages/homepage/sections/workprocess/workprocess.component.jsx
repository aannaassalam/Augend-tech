    ...
    <div className="workprocess">
      ...
      <div className="part part1">
        ...
        <div className="right">
          ...
          <div className="content">
            ...
            <h4>
              The first meeting is very important to get acquainted and discuss
              the
              <br />
      ...
      <div className="part part2">
        <div className="right">
          ...
          <div className="content">
            ...
            <h4>
              When we understand the main ideas, we proceed to
              <br />
              discuss the work plan and analyze it.
            </h4>
          </div>
        </div>
        <div className="left">
      ...
      <div className="part part3">
        ...
        <div className="right">
          ...
          <div className="content">
            ...
            <h4>
              Our professional team starts to work on your project and embody
              all
              <br />
              details of the initial concept.
            </h4>
          </div>
        </div>
      ...
      <div className="part part4">
        <div className="right">
          <h2>04</h2>
          <div className="content">
            <h3>Once Again We Analyze And Check Everything</h3>
            <h4>
              We meet, analyze and check the work we done on the project and
              <br />
      ...
      <div className="part part5">
        ...
        <div className="right">
          ...
          <div className="content">
            ...
            <h4>
              The project is completed and we give it to our customer. We also
              ask
              <br />
