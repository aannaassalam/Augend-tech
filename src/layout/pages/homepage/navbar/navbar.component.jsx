              ...
              <div className='full-menu'>
                  <div className="full-menu-context">
                          <div className="full-menu-context-main">
                                      <ul>
                                          <li><a className="primary-menu" href="/services/web-development">Web Development</a></li>
                                          <li><a className="primary-menu" href="/services/digital-marketing">Digital Marketing</a></li>
                                          <li><a className="primary-menu" href="/services/app-development">App Development</a></li>
                                          <li><a className="secondary-menu" href="/works">Our Works</a></li>
                                          <li><a className="secondary-menu" href="/blog">Blog</a></li>
                                          <li><a className="secondary-menu" href="#section-8">Seo-Analysis</a></li>
                          ...
                          <div className="full-menu-context-connect">
                              ...
                              <div className="get-in-touch">
                                  <a className="get-in-touch-btn" href="#section-8">Get a Quote</a>
                              </div>
                          </div>
